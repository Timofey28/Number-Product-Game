...
#include "RecordsObserver.cpp"
using namespace std;
mt19937 mersenne(static_cast<unsigned int>(time(0)));

enum colors {RED = 4, GREEN = 10, LIGHT_RED = 12, WHITE = 15} color;
...
void help(RecordsObserver* recordsObserver, char& buffer)
{
    system("cls");
    setColor(RED);   cout << "\n    " << "Пробел";
    setColor(7); cout << " - пауза/пуск, во время\n    паузы время приостанавливается";
    setColor(RED);   cout << "\n    " << "n (next)";
    setColor(7); cout << " - следующий пример\n";

    setColor(RED);   cout << "\n    " << "1";
    setColor(7); cout << " - лучший результат";
    setColor(RED);   cout << "\n    " << "[5, 2, 4, 0]";
    setColor(7); cout << " - лучшие средние из\n    5, 20, 50 и 100 соответственно";
    setColor(RED);   cout << "\n    " << "l (last)";
    setColor(7); cout << " - последние 100 попыток";
    setColor(RED);   cout << "\n    " << "Любая другая клавиша";
    setColor(7); cout << " == следу-\n    ющий пример";
    ...
    setPosition(39, 2);
    setColor(RED);   cout << "n";
    setColor(7); cout << " - к следующему рекорду";
    setPosition(39, 3);
    setColor(RED);   cout << "N";
    setColor(7); cout << " - к предыдущему рекорду";
    ...
    setColor(7); cout << " - вниз, вверх";
    setPosition(39, 7);
    setColor(RED);   cout << "C^j, C^k";
    setColor(7); cout << " - до конца вниз, до начала";
    setPosition(39, 8);
    cout << "вверх (аналогично со стрелками)";
    setPosition(39, 9);
    setColor(RED);   cout << "Enter";
    setColor(7); cout << " - возвращение в главный режим";
    setPosition(39, 10);
    setColor(RED);   cout << "Esc";
    setColor(7); cout << " - выход с сохранением!";
